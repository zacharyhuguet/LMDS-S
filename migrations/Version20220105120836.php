...
final class Version20220105120836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(50) NOT NULL, date DATE NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, telephone VARCHAR(10) NOT NULL, marque VARCHAR(50) NOT NULL, modele VARCHAR(50) NOT NULL, probleme VARCHAR(50) NOT NULL, commentaire VARCHAR(255) NOT NULL, protection VARCHAR(3) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
